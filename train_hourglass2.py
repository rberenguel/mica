#!/usr/bin/env python3
"""
Hourglass phase 2 — extended fine-tune on the noir corpus.

Loads mica_hourglass_v2_phase1.pt (already folded to [2+6+2]), restores the
hard ties, then fine-tunes on noir at a very low learning rate for 20k steps.
No further folding.

Saves mica_hourglass_v2_long.pt on completion.
"""
import math
import os
import numpy as np
...
from model_hourglass import HourglassTransformer, restore_folds

PHASE1_CHECKPOINT = "mica_hourglass_v2_phase1.pt"
CHECKPOINT        = "mica_hourglass_v2_long_ckpt.pt"
WEIGHTS_OUT       = "mica_hourglass_v2_long.pt"
