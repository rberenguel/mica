#!/usr/bin/env python3
"""
Generate text with Mica Hourglass.
...
parser = argparse.ArgumentParser(description="Generate text with Mica Hourglass")
...
parser.add_argument("--weights",                    default="mica_hourglass_v2.pt", help="Path to weights")
